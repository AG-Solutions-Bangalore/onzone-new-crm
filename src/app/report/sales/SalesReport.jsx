...
const SalesReport = () => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      work_order_sa_from_date: defaultFromDate,
        ...
        <CardContent>
          ...
          >
            <div className="space-y-1">
              <Label htmlFor="work_order_sa_from_date">From Date</Label>
              <Input
            ...
            <div className="space-y-1">
              <Label htmlFor="work_order_sa_to_date">To Date</Label>
              <Input
            ...
            <div className="space-y-1">
              <Label htmlFor="work_order_sa_retailer_id">Retailer Id</Label>
              <Input
