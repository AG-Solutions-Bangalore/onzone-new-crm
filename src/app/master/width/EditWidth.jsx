        ...
        {isFetching ? (
          ...
          <div className="grid gap-4">
            <div className="space-y-2">
              <h4 className="font-medium leading-none">Edit Width</h4>
              <p className="text-sm text-muted-foreground">
                Update width details
              </p>
            </div>
            <div className="grid gap-2">
              <div className="grid gap-1">
                <label htmlFor="width_mea" className="text-sm font-medium">
                  Width
                </label>
              ...
              <div className="grid gap-1">
                <label htmlFor="width_status" className="text-sm font-medium">
                  Status
                </label>
                <Select
